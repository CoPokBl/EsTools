...
public class Tester {
    ...
    private static final TestCommand[] routine = new TestCommand[] {
            ...
            new TestCommand("h dirt", 0.1),
            new TestCommand("bukkitdata set estools:hello string wassup", 2, new SemanticVersion(1, 14, 0)),
            new TestCommand("bukkitdata get estools:hello", 2, new SemanticVersion(1, 14, 0)),
            new TestCommand("bukkitdata remove estools:hello", 2, new SemanticVersion(1, 14, 0)),
            new TestCommand("bukkitdata get estools:hello", 2, new SemanticVersion(1, 14, 0)),
